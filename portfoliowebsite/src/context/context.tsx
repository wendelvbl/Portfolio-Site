...
},
{
  "id": 17,
  "date": "2025-05-15",
  "title": "Dieper in de NPM Package – Decorators, Dialecten & Refactors",
  "message": "Deze week bouwden we voort op de fundamenten van onze eigen NPM package, en maakten we concrete stappen richting een robuuste en veilige query builder. Wat begon als uitbreiding, groeide al snel uit tot een verfijningsslag op meerdere fronten.\n\nOp maandag werkten we verder aan de bestaande package, en introduceerden we een tweede package die zich focust op decorators binnen de query builder. Deze decorators zorgen voor extra structuur en controle in hoe queries worden opgebouwd – een waardevolle toevoeging.\n\nDinsdag stond in het teken van veiligheid en connectiviteit. Ik werkte aan het maken van een connectie met een database vanuit de builder, en voegde een escape-mechanisme toe binnen het dialect om SQL-injecties te voorkomen. Dit gaf niet alleen inzicht in query-analyse, maar ook in hoe belangrijk het is om beveiliging al op laag niveau in te bouwen.\n\nWoensdag was een dag van structuur en probleemoplossing. Ik refactorde het `where`-gedeelte en verplaatste de logica naar het dialectsysteem, zodat de opbouw van queries per dialect eenvoudiger te beheren is. Ook stootte ik op een probleem in de `tsconfig` waardoor dependencies niet goed meegebundeld werden – gelukkig kon ik dit oplossen na wat debugging.\n\nOp donderdag lag de focus opnieuw op refactoring, ditmaal met het oog op modulariteit en onderhoudbaarheid. Daarnaast breidde ik de functionaliteit van de decorators verder uit, waardoor de package niet alleen krachtiger werd, maar ook eleganter in gebruik.\n\nDeze week draaide om verdieping: zowel technisch – met security, structuur en tooling – als persoonlijk, in het ontwikkelen van een scherpere blik op schaalbare en veilige code. Elke commit voelt meer als een stap richting iets dat écht bruikbaar is voor anderen.",
  "tags": ["NPM", "QueryBuilder", "Decorators", "Refactoren", "Dialect", "SQL Injection", "TSConfig", "Stage"]
},
    {
  "id": 18,
  "date": "2025-05-22",
  "title": "Fijnslijpen, Uitbreiden & Afscheid – De Laatste Loodjes van Mijn Stage",
  "message": "De laatste volledige week van mijn stage was er eentje van afronden, uitbreiden en afscheid nemen. Terwijl de NPM package steeds completer werd, begon ook het einde van dit hoofdstuk in zicht te komen.\n\nOp maandag werkte ik verder aan de query builder en voegde ik meerdere functies toe: `getBy`, `getById`, `getFirst` en verbeterde ik de `where`-functionaliteit, zodat ook `whereBy` en `whereOr` correct functioneren. Dit zorgde voor een veelzijdigere en gebruiksvriendelijkere API.\n\nDinsdag lag de focus op verfijning. Ik herwerkte de `orWhere`-logica en bracht verdere verbeteringen aan in het dialect-systeem. Het is boeiend om te zien hoe kleine aanpassingen op laag niveau grote impact kunnen hebben op de hele structuur van de package.\n\nWoensdag breidde ik de builder opnieuw uit met belangrijke functies zoals `having`, `limit` en een verbeterde `first`. Hiermee komt de package steeds dichter bij een volwaardige tool voor het bouwen van complexe database queries.\n\nDonderdag voelde als een symbolisch moment. Ik nam de tijd om nog eens door mijn projecten te gaan, voerde een uitgebreide code review uit samen met Wim en nam afscheid van een aantal collega's die ik volgende week niet meer zal zien. Daarnaast had ik een boeiend gesprek met de HR-directeur en werkte ik nog wat verder aan de laatste details van de NPM package.\n\nHet is vreemd hoe snel tijd kan gaan. Wat begon als een uitdaging, voelt nu als een afgerond verhaal waarin ik heb kunnen groeien – technisch, maar zeker ook persoonlijk.",
  "tags": ["NPM", "QueryBuilder", "WhereOr", "GetBy", "Limit", "Having", "Dialect", "Stage", "CodeReview", "Afscheid"]
}
